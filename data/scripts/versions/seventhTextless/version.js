...
function bottomInfoSeventhTextless() {
	...
	writeText(
		[
			...
			{text: '{center}NOT FOR SALE   Personal Proxy', x: 92/1500, y: 1995/2100, width: 1316/1500, height: 30/2100, font: 'mplantin', fontSize: 30/2100, fontColor: 'white', otherParameters: ['oneLine=true','shadow=' + scaleY(4/2100)]},
		], bottomInfoContext)
}