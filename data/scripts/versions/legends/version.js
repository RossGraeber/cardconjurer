...
function bottomInfoLegends() {
	...
	writeText(
		[
			...
			{text: 'NOT FOR SALE   Personal Proxy', x: 150/1500, y: 2008/2100, width: 1200/1500, height: 30/2100, font: 'mplantin', fontSize: 30/2100, fontColor: '#eee', otherParameters: ['oneLine=true','shadow=' + scaleY(3/2100)]},
		], bottomInfoContext)
}