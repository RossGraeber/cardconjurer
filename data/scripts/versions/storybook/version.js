...
function bottomInfoStorybook() {
	...
	writeText(
		[
			...
			{text: '{right}Personal Proxy', x: 97/1500, y: 2030/2100 + ptBoxShift, width: 1306/1500, height: 30/2100, font: 'mplantin', fontSize: 30/2100, fontColor: 'white', otherParameters: ['oneLine=true', 'outline=true', 'outlineThickness=8']}
		], bottomInfoContext)
}