...
function bottomInfoPlanechase() {
	...
	writeText(
		[//{artistbrush}{fontbelerenbsc}' + document.getElementById('inputInfoArtist').value
			...
			{text: '{center}NOT FOR SALE{right' + scaleX(0.01) + '}{fontmplantin}Personal Proxy', x: 670/2100, y: 2078/2100, width: 760/2100, height: 30/2100, font: 'gothammedium', fontSize: 30/2100, fontColor: 'white', otherParameters: ['oneLine=true', 'outline=true', 'outlineThickness=8']},
		], bottomInfoContext)
}