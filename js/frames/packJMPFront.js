...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	await loadBottomInfo({
		...
		bottomRight: {text:'Personal Proxy', x:0.0647, y:0.972, width:0.8707, height:0.0143, oneLine:true, font:'mplantin', size:0.0143, color:'white', align:'right', outlineWidth:0.003},
