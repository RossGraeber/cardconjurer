...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadBottomInfo({
		...
		bottom: {text:'{ptshift-0.1667,0}NOT FOR SALE   Personal Proxy', x:0.08, y:1990/2100, width:0.8107, height:0.0134, oneLine:true, font:'mplantin', size:0.0134, color:'white', shadowX:0.0007, shadowY:0.0005}
	});
}
