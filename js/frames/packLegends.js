...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadBottomInfo({
		...
		cc: {text:'NOT FOR SALE   Personal Proxy', x:0.0614, y:0.9791, width:0.8774, height:0.0124, oneLine:true, size:0.0124, align:'center', color:'#dedede', outlineWidth:0.003}
	});
}
